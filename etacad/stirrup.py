...
if __name__ == "__main__":
    ...
    st_horizontal = Stirrup(width=0.15, height=0.2, diameter=0.008, reinforcement_length=0.6, spacing=0.15, x=0, y=0,
                            mandrel_radius_bottom=0.004, mandrel_radius_top=0.006, anchor=0.1,
                            direction="horizontal", orientation="down")

    st_horizontal.draw_transverse(document=doc, unifilar=False, dimensions=False)
    msp.add_circle(center=(0, 0), radius=.1)

    st_horizontal.draw_transverse(document=doc, x=2, y=1, unifilar=True)
    st_horizontal.draw_longitudinal(document=doc, x=2.5, y=1, unifilar=True)

    st_horizontal.draw_transverse(document=doc, x=2, y=2, unifilar=False)
    st_horizontal.draw_longitudinal(document=doc, x=2.5, y=2, unifilar=False)
    ...
    st_horizontal.draw_transverse(document=doc, x=-2.5, y=1, unifilar=True)
    st_horizontal.draw_longitudinal(document=doc, x=-2, y=1, unifilar=True)

    st_horizontal.draw_transverse(document=doc, x=-2.5, y=2, unifilar=False)
    st_horizontal.draw_longitudinal(document=doc, x=-2, y=2, unifilar=False)
    ...
    st_vertical_left = Stirrup(width=0.3, height=0.2, diameter=0.008, reinforcement_length=0.6, spacing=0.1, x=4, y=1,
                               mandrel_radius_bottom=0.004, mandrel_radius_top=0.006, anchor=0.075,
                               direction="vertical", orientation="left")

    st_vertical_left.draw_transverse(document=doc, x=4, y=1, unifilar=False)
    st_vertical_left.draw_longitudinal(document=doc, x=4.5, y=1, unifilar=False)

    st_horizontal_right = Stirrup(width=0.3, height=0.2, diameter=0.008, reinforcement_length=0.6, spacing=0.1, x=5,
                                  y=1, mandrel_radius_bottom=0.004, mandrel_radius_top=0.006, anchor=0.075,
                                  direction="vertical", orientation="right")

    st_horizontal_right.draw_transverse(document=doc, x=5, y=1, unifilar=True)
    st_horizontal_right.draw_transverse(document=doc, x=5.5, y=1)

    doc.saveas("c:/users/beta/desktop/stirrup.dxf")
